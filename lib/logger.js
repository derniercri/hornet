...
Logger.prototype = {
  ...
  debug : function( msg, module ) {
    ...
    this.logger.info("[ DEBUG ] [" + moduleName + "] " + msg.toString());
  },
  ...
  error : function( msg, module ) {
    ...
    var moduleName = this._getModuleName( module );
    this.logger.info("[ ERROR ] [" + moduleName + "] " + msg.toString());
  },
  ...
  log : function( msg, module ) {
    ...
    var moduleName = this._getModuleName( module );
    this.logger.info("[ INFO ] [" + moduleName + "] " + msg.toString());
  },
  ...
  warn : function( msg, module ) {
    ...
    var moduleName = this._getModuleName( module );
    this.logger.info("[ WARN ] [" + moduleName + "] " + msg.toString());
  },
