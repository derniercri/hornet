...
consts['HORNET_USER_SPECIFIC_CHANNEL_PREFIX'] =
  consts['HORNET_CHANNEL'] + ':channel:'
consts['HORNET_EVENTS_CHANNEL'] = 'events'
consts['HORNET_EVENT_CONNECT_CHANNEL'] =
  consts['HORNET_CHANNEL'] +
  ':' +
  consts['HORNET_EVENTS_CHANNEL'] +
  ':' +
  'connect'
...
consts['SERVER_PORT'] = process.env.PORT || 8187

consts['TYPE_ERROR_MESSAGE'] = 'error'
consts['TYPE_INFO_MESSAGE'] = 'info'
consts['TYPE_CONNECTED'] = 'connected'

consts['REDIS_URI'] = process.env.REDIS_URI || 'redis://locahost:6379'
